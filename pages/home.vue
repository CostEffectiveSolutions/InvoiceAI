...
// SEO
useHead({
  title: 'znAI | Персонализиран софтуер по ваше задание',
  meta: [
    { 
      name: 'description', 
...
const testimonials = [
  {
    ...
    content: "znAI трансформира нашите бизнес процеси с иновативни AI решения. Впечатляващо внимание към детайла и перфектна оптимизация."
  },
  {
