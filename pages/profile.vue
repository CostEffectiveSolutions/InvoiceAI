  ...
  <div class="bg-gradient-to-b from-blue-50 to-white min-h-screen pt-12 pb-16">
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-12">
          ...
          <h1 class="text-4xl font-bold text-navy-900">
            Your <span class="bg-gradient-to-r from-blue-600 to-blue-400 text-transparent bg-clip-text">Profile</span>
          </h1>
        </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
              ...
              <div class="flex-1 text-center md:text-left">
                ...
                <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                  <Badge variant="outline" class="bg-blue-50/50 text-blue-700 border-blue-200 rounded-full">
                    Member
                  </Badge>
                  <Badge variant="outline" class="bg-green-50/50 text-green-700 border-green-200 rounded-full">
          ...
          <div class="glass-morphic p-8 rounded-3xl mb-8">
            <div class="flex justify-between items-center mb-6">
              ...
              <Button variant="outline" class="rounded-full" @click="isEditing = !isEditing">
                <Icon :name="isEditing ? 'lucide:x' : 'lucide:pencil'" class="w-4 h-4 mr-2" />
    ...
    <Dialog :open="confirmDelete" @update:open="confirmDelete = $event">
      <DialogContent class="rounded-3xl bg-white/90 backdrop-blur-md border border-white/30">
        ...
        <div class="py-4">
          <p class="text-gray-600">All your personal data will be permanently removed. This includes:</p>
        ...
        <DialogFooter>
          <Button variant="ghost" @click="confirmDelete = false" class="rounded-full">
            Cancel
          </Button>
          <Button 
            variant="destructive" 
...
watch(user, (newValue) => {
  if (newValue) {
    ...
    avatarPath.value = newValue.avatar_url || null
  }
}, { immediate: true })
