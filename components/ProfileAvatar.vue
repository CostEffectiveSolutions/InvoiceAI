...
const downloadImage = async () => {
  try {
    ...
    const { data, error } = await supabase.storage.from('files').download(path.value)
...
<template>
  <div class="flex flex-col items-center">
    ...
    <div class="relative">
      ...
      <div v-else class="bg-blue-100 rounded-full flex items-center justify-center" :style="{ height: size, width: size }">
